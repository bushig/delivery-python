...
class Container(BaseContainer):
    ...
    from delivery.adapters.out.postgres.database import async_session_factory
    from delivery.adapters.out.postgres.courier_repository import CourierRepository
