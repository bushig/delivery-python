...
from src.core.domain.model.order.assignment import Assignment, AssignmentStatusEnum
...
def test_cant_complete_same_assignment_twice():
    ...
    assignment_1.complete(courier_location=Location(1, 4))
...
def test_can_complete_when_courier_is_adjacent_or_at_location():
    ...
    assignment.complete(courier_location=Location(5, 5))
    ...
    assignment_2.complete(courier_location=Location(5, 6))
...
def test_cant_complete_when_courier_is_too_far():
    ...
    with pytest.raises(ValueError):
        assignment.complete(courier_location=Location(5, 7))
